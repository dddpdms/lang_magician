...
model = load_facebook_vectors('C:/Users/ai/Desktop/sg300_chair1_shoulder.bin')
f = open("C:/Users/ai/Desktop/data/교정실험_after_어깨번호/붙힌것/의자_세종1.txt", 'r', encoding='utf-8', newline='\n', errors='ignore')
...
while True:
    ...
    for i in split_list:
        if target_word in i:
            ...
            temp_str = split_list[cut_num].replace("의자.03", "의지.06")
